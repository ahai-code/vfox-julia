...
utilSingleton.SOURCE_URL = "https://raw.githubusercontent.com/ahai-code/sdk-sources/main/julia.json"
...
function util:getInfo()
    ...
    for version, array in pairs(respInfo) do
        ...
        table.insert(utilSingleton.RELEASES,{version = version,url=url,sha256=sha256})
    end
